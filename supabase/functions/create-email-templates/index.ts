  ...
  try {
    ...
    const templates = [
      ...
      },
      {
        ...
        type: "Transactional",
        subject: "Your payout for {{event_title}} is ready! 💰",
        content: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            <div style="text-align: center; padding: 20px; background: #ecfdf5; border-radius: 8px; margin-bottom: 20px;">
              <h1 style="color: #059669; margin: 0;">Payout Ready! 💰</h1>
            </div>
            
            <p>Hi {{host_name}},</p>
            
            <p>Great news! Your payout for <strong>{{event_title}}</strong> is ready and will be transferred to your account.</p>
            
            <div style="background: #ecfdf5; padding: 20px; border-radius: 8px; margin: 20px 0;">
              <h3 style="color: #059669; margin-top: 0;">💰 Payout Details</h3>
              <p style="color: #065f46;"><strong>Event:</strong> {{event_title}}<br>
              <strong>Event Date:</strong> {{event_date}}<br>
              <strong>Gross Amount:</strong> {{total_amount}}<br>
              <strong>Platform Fee:</strong> 5%<br>
              <strong>Net Payout:</strong> Amount after fees<br>
              <strong>Transfer Date:</strong> Within 2 business days</p>
            </div>
            
            <div style="background: #f8fafc; padding: 20px; border-radius: 8px; margin: 20px 0;">
              <h3 style="color: #374151; margin-top: 0;">📊 Event Stats</h3>
              <p>Your event was a success! Thank you for creating such a wonderful experience for your guests.</p>
            </div>
            
            <div style="text-align: center; margin: 30px 0;">
              <a href="#" style="background: #059669; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold;">View Payout Details</a>
            </div>
            
            <p>Ready to host your next amazing event?</p>
            
            <p style="color: #6b7280; font-size: 14px; margin-top: 30px;">
              Thank you for hosting,<br>
              The Provaa Team
            </p>
          </div>
        `,
      ...
      {
        name: "New Host Welcome",
        type: "Transactional",
        subject: "Welcome to Provaa Hosting! 🎉 Let's get started",
        content: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            <div style="text-align: center; padding: 20px; background: #ecfdf5; border-radius: 8px; margin-bottom: 20px;">
              <h1 style="color: #059669; margin: 0;">Welcome, Host! 🎉</h1>
            </div>
            
            <p>Hi {{host_name}},</p>
            
            <p>Welcome to the Provaa hosting community! We're excited to help you share your passion for food and create unforgettable experiences.</p>
            
            <div style="background: #fef3c7; padding: 20px; border-radius: 8px; margin: 20px 0;">
              <h3 style="color: #92400e; margin-top: 0;">🚀 Getting Started</h3>
              <p style="color: #92400e;">1. Complete your host profile<br>
              2. Set up your payout information<br>
              3. Create your first event<br>
              4. Share your unique culinary story</p>
            </div>
            
            <div style="text-align: center; margin: 30px 0;">
              <a href="#" style="background: #059669; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold; margin-right: 10px;">Complete Profile</a>
              <a href="#" style="background: #6b7280; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold;">Create First Event</a>
            </div>
            
            <div style="background: #ecfdf5; padding: 20px; border-radius: 8px; margin: 20px 0;">
              <h3 style="color: #059669; margin-top: 0;">💡 Host Tips</h3>
              <p style="color: #065f46;">• High-quality photos increase bookings by 70%<br>
              • Detailed descriptions help guests know what to expect<br>
              • Quick responses to questions build trust<br>
              • Personal touches make experiences memorable</p>
            </div>
            
            <p>Need help getting started? Our support team is here to guide you every step of the way!</p>
    ...
    for (let i = 0; i < templates.length; i += batchSize) {
      ...
      console.log(`Inserted batch ${Math.floor(i / batchSize) + 1}: ${insertedCount}/${templates.length} templates`);
    }

    console.log(`Successfully created ${insertedCount} email templates`);

    return new Response(
      JSON.stringify({ 
        success: true, 
        message: `Successfully created ${insertedCount} email templates`,
        templatesCreated: insertedCount
      }),
      {
